...
<link rel="stylesheet" href="catalog/view/theme/yaltaland/js/dist/jquery.fancybox.min.css">
<script src="catalog/view/theme/yaltaland/js/dist/jquery.fancybox.js"></script>
