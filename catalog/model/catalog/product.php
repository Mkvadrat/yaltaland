...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'description_image' => $query->row['description_image'],
				'tag'              => $query->row['tag'],
				...
				'coordinates'      => $query->row['coordinates'],
	...
	public function getProductSlider($product_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_slider WHERE product_id = '" . (int)$product_id . "' ORDER BY date_added ASC");
