        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-skype">Скайп</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_skype" value="<?php echo $config_skype; ?>" placeholder="Скайп" id="input-skype" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-title-header">Заголовок в шапке сайта:</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_title" value="<?php echo $config_title; ?>" placeholder="Заголовок в шапке сайта:" id="input-title-header"" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
